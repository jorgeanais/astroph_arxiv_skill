...
1. **Construct the Query:**
   ...
   - The category is FIXED to astrophysics. Use `cat:astro-ph` (or `cat:astro-ph.GA` for galactic structures).
   ...
   - Combine parameters: `?search_query=cat:astro-ph.GA+AND+all:"<user_topic>"&sortBy=submittedDate&sortOrder=desc&max_results=<number>`
   - Ensure spaces and quotes are URL-encoded.
